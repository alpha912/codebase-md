...
suite('Extension Test Suite', function () {
    ...
    test('Extension should activate', function () { return __awaiter(void 0, void 0, void 0, function () {
        var extension;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    extension = vscode.extensions.getExtension('alpha912.codebase-md');
                    assert.strictEqual(extension === null || extension === void 0 ? void 0 : extension.isActive, false);
